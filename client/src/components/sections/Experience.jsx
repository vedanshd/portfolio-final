...
var ExperienceItem = function (_a) {
    var title = _a.title, company = _a.company, location = _a.location, duration = _a.duration, responsibilities = _a.responsibilities;
    return (<AnimatedCard>
    ...
    <div className="mt-4">
      <ul className="space-y-4 text-muted-foreground">
        {responsibilities.map(function (resp, index) { return (<li key={index} className="flex items-start">
...
var Experience = function () {
    ...
    return (<section id="experience" className="py-20 bg-secondary">
