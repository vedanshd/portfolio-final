...
var About = function () {
    ...
    var techStackRef = useRef(null);
    var contentInView = useInView(contentRef, {
        once: true,
        margin: '-100px 0px',
    });
    var techStackInView = useInView(techStackRef, {
        once: true,
        margin: '-100px 0px',
    });
    ...
    return (<section id="about" className="py-20 bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div ref={contentRef} initial="hidden" animate={contentInView ? 'visible' : 'hidden'} variants={fadeIn}>
            ...
            <div className="flex space-x-4 mt-8">
              ...
              <a href="#" className="text-accent hover:text-foreground transition-colors duration-300" aria-label="GitHub">
                <Github className="h-6 w-6"/>
              </a>
            </div>
          </motion.div>

          <motion.div ref={techStackRef} initial="hidden" animate={techStackInView ? 'visible' : 'hidden'} variants={fadeIn}>
            <GradientBorder>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {['Python', 'Java', 'JavaScript', 'C++'].map(function (lang) { return (<li key={lang} className="flex items-center">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {['React.js', 'FastAPI', 'AWS', 'Azure AI'].map(function (tech) { return (<li key={tech} className="flex items-center">
